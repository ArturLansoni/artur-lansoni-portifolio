...
function SpringIcon({ width = 16, height = 16, color = '#6DB33F' }: IconProps) {
	return (
		<svg
			width={width}
			height={height}
...
export default memo(SpringIcon)
